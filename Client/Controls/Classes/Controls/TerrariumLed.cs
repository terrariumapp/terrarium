...
namespace Terrarium.Forms
{
	...
	public class TerrariumLed : GlassButton
	{
		...
		private GlassGradient idleGradient = new GlassGradient(Color.FromArgb(128, 255, 128), Color.FromArgb(0, 96, 0));
		private GlassGradient waitingGradient = new GlassGradient(Color.FromArgb(255, 255, 128),Color.FromArgb(128, 128, 0));
		private GlassGradient failedGradient = new GlassGradient(Color.FromArgb(255, 128, 128), Color.FromArgb(128, 0, 0));
		...
		//    {
		//        case LedStates.Idle:
		//            this.DisabledGradient = this.idleGradient;
		//            break;
		//        case LedStates.Waiting:
		//            this.DisabledGradient = this.waitingGradient;
		//            break;
		//        case LedStates.Failed:
		//            this.DisabledGradient = this.failedGradient;
		//            break;
		//    }
		//    base.OnPaint (e);
		//}
