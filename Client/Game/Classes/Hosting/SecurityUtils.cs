...
namespace Terrarium.Hosting 
{
    ...
    public class SecurityUtils
    {
        ...
        {
            Assembly asm = System.Reflection.Assembly.GetAssembly(t);
            if (asm == null)
            {
                throw new Exception("Can't get assembly for " + t.ToString());
            }
        ...
        internal static PolicyLevel MakePolicyLevel(string cacheDir)
        {
            ...
            // My Computer, Nothing
            FirstMatchCodeGroup myComputer = new FirstMatchCodeGroup( new ZoneMembershipCondition(SecurityZone.MyComputer), 
                new PolicyStatement(noPerms));
