...
namespace Terrarium.Client.SplashScreen 
{
    ...
    internal class SplashWindow : MarshalByRefObject
    {
        ...
        internal void Show()
        {
            if (_hwnd == IntPtr.Zero)
            {
                Thread thread = new Thread(new ThreadStart(SplashWindow.ThreadFunction));
        ...
        private static void ThreadFunction()
        {
            ...
            if (result)
            {
                ...
                if (current._formToActivate != null)
                {
                    ...
                    //current._formToActivate.Activate();
        ...
        private const int WS_OVERLAPPEDWINDOW = (0x00000000|0x00C00000|0x00080000|0x00040000|0x00020000|0x00010000);
