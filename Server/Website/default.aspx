      ...
      <td align="center" valign="top">
        <table width="80%" height="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <!-- LEFT SHADOW -->
            <td width="30px">
              <asp:Image ImageUrl="~/images/border_left.png" Width="30px" Height="100%" runat="server" ID="Image2" />
            </td>
                          ...
                          <table class="SectionPanel" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                              <td>
                                ...
                                <br />
                                <div>
                                  You can install the latest client <a href="./Publish/default.aspx"><b>here</b></a>.
                                </div>
                                <br />
                                <div>
                                  <b>NOTE:</b> You must be running .NET 2.0 Beta 2 or later. The install page will
                                  detect if you have it and prompt you to install it.</div>
                              </td>
                            </tr>
                          </table>
                        </td>
                          ...
                          <table class="SectionPanel" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                              <td>
                                ...
                                <br />
                                <div>Available now is a page that you can use to track your usage statistics. Check it out <a href="Usage/default.aspx"><b>now</b></a>!</div>
                                <br />
                              </td>
                            </tr>
                          </table>
                            ...
                            <tr>
                              <td>
                                ...
                                <div>
                                  ...
                                  resolved and new issues are discovered.</div>
                                <ul type="disc" style="margin: 4 auto 4 auto;">
                                  <li style="margin-bottom: 6;"><b>Rendering Issues under Remote Desktop Connection</b><br />
                                    There are several artifacts and drawing problems that occur when running Terrarium
                                    via Remote Desktop Connection. Things like tool tips in the wrong spot or clipped, the world
                                    view being rendered incorrectly are a couple of known problems.</li>
            ...
            <td width="30px">
              <asp:Image ImageUrl="~/images/border_right.png" Width="30px" Height="100%" runat="server" /></td>
          </tr>
