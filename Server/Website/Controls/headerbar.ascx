...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><h5 style="margin-top:16px;margin-bottom:5px;">&nbsp;.NET Terrarium Version 2.0</h5></td>
  </tr>
  <tr>
    <td colspan="2">
      <asp:Image ID="Image1" ImageUrl="~/images/banner_bottom_middle.png" Height="1px" Width="100%"
        runat="server" /></td>
    <td>
  ...
  <tr>
    ...
    <td width="128px">
      <asp:Image ImageUrl="~/images/banner_center_right.png" runat="server" Width="128px"
        Height="100%" />
    </td>
  </tr>
  <tr>
    <td colspan="2">
      <asp:Image ImageUrl="~/images/banner_bottom_middle.png" Height="1px" Width="100%"
        runat="server" /></td>
    <td>
